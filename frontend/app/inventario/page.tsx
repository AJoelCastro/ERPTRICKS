    ...
    <div className="space-y-4 sm:space-y-6">
      <section className="rounded-2xl bg-white p-4 shadow-sm sm:rounded-3xl sm:p-6">
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          <div>
            <h1 className="text-xl font-black text-slate-900 sm:text-2xl">Inventario</h1>
          ...
          <div className="grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto sm:flex-wrap">
            ...
            <button
              ...
              className="rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white hover:bg-slate-800 sm:py-2"
            >
              Scanner
            </button>
          </div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <div className="text-xs text-slate-500">
                        {it.producto.color} · {it.producto.material} · Taco {it.producto.taco} · T{it.producto.talla}
                      </div>
                    </div>
                    <div>{badgeEstado(it.producto.estado)}</div>
                  </div>

                  <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-slate-600">
                    <div>
                      <span className="font-semibold">Almacén:</span> {it.almacen.codigo}
                    </div>
                    <div>
                      <span className="font-semibold">Stock:</span> {Number(it.stock || 0)}
                    </div>
                    <div className="col-span-2 break-all">
                      <span className="font-semibold">SKU:</span> {it.sku}
                    </div>
                    <div className="col-span-2 break-all">
                      <span className="font-semibold">Código barras:</span> {it.codigoBarras}
                    </div>
                  </div>
      ...
      <section className="rounded-2xl bg-white p-4 shadow-sm sm:rounded-3xl sm:p-6">
        ...
        <div className="mb-4 grid gap-3 grid-cols-1 sm:grid-cols-2 xl:grid-cols-5">
          <input
            value={movQ}
          ...
          <>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <div className="text-xs text-slate-500">
                        {mov.producto.color} · T{mov.producto.talla}
                      </div>
                    </div>
                    <div>{badgeTipo(mov.tipo)}</div>
                  </div>

                  <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-slate-600">
                    <div>
                      <span className="font-semibold">Fecha:</span> {formatFecha(mov.createdAt)}
                    </div>
                    <div>
                      <span className="font-semibold">Almacén:</span> {mov.almacen.codigo}
                    </div>
                    <div>
                      <span className="font-semibold">Cantidad:</span> {mov.cantidad}
                    </div>
                    <div>
                      <span className="font-semibold">Stock nuevo:</span> {mov.stockNuevo}
                    </div>
                    <div className="col-span-2 break-all">
                      <span className="font-semibold">SKU:</span> {mov.sku || "-"}
                    </div>
                    <div className="col-span-2 break-all">
                      <span className="font-semibold">Referencia:</span> {mov.referencia || "-"}
                    </div>
                    <div className="col-span-2 break-all">
                      <span className="font-semibold">Usuario:</span> {mov.usuarioEmail || "-"}
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
              ...
              <div className="grid grid-cols-3 gap-2 sm:flex sm:items-center">
                ...
                <div className="flex items-center justify-center rounded-lg bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700">
                  {movPaginaActual} / {movTotalPaginas}
                </div>
      ...
      {modalOpen && itemActivo && (
        <div className="fixed inset-0 z-50 bg-black/40 p-0 sm:flex sm:items-center sm:justify-center sm:p-4">
          <div className="flex h-dvh w-full flex-col bg-white shadow-xl sm:h-auto sm:max-h-[90vh] sm:max-w-2xl sm:rounded-3xl sm:p-6">
      ...
      {scannerOpen && (
        <div className="fixed inset-0 z-50 bg-black/40 p-0 sm:flex sm:items-start sm:justify-center sm:p-4">
          <div className="flex h-dvh w-full flex-col bg-white shadow-xl sm:h-auto sm:max-h-[95vh] sm:max-w-md sm:rounded-3xl sm:p-5">
            <div className="sticky top-0 z-10 border-b border-slate-200 bg-white p-4 sm:static sm:border-0 sm:bg-transparent sm:p-0 sm:pb-3">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-0">
              <div className="mb-3 grid grid-cols-1 gap-2 rounded-2xl bg-slate-50 p-3 sm:flex sm:flex-wrap">
